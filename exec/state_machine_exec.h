 ...
 *
 */
class StateMachineExec : public ::haomo::pos::IExec
{
public:
    /**
     * @brief Construct a new StateMachineExec object
     *
     * @param name
     * @param type
     */
    StateMachineExec(const std::string& name, const std::string& type) : IExec(name, type)
    {
    }

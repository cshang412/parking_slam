 ...
 *
 */
class ReferenceLineServiceExec : public ::haomo::pos::IExec
{
public:
    /**
     * @brief Construct a new ReferenceLineServiceExec object
     *
     * @param name
     * @param type
     */
    ReferenceLineServiceExec(const std::string& name, const std::string& type) : IExec(name, type)
    {
    }
